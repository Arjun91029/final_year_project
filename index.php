    ...
    <div class="container"><!-- container Starts -->
        ...
        <div class="col-md-6"><!-- col-md-6 Starts -->
            <ul class="menu"><!-- menu Starts -->
                ...
                <li>
                    <?php
                    echo isset($_SESSION['customer_email']) ? "<a href='customer/my_account.php?my_orders'>My Account</a>" : "<a href='checkout.php'>My Account</a>";
                    ?>
                </li>
                <li><a href="cart.php">Go to Cart</a></li>
                <li>
                    <?php
                    echo isset($_SESSION['customer_email']) ? "<a href='logout.php'>Logout</a>" : "<a href='checkout.php'>Login</a>";
                    ?>
                </li>
            </ul><!-- menu Ends -->
        </div><!-- col-md-6 Ends -->
    ...
    <div class="col-md-12"><!-- col-md-12 Starts -->
        <div id="myCarousel" class="carousel slide" data-ride="carousel"><!-- carousel slide Starts --->
            ...
            <div class="carousel-inner"><!-- carousel-inner Starts -->
                <?php
                $get_slides = "SELECT * FROM slider LIMIT 0,4";
