        ...
        <div class="col-md-9"><!-- col-md-9 Starts -->
            <div class="box"><!-- box Starts -->
                ...
                if (isset($_POST['submit'])) {
                    ...
                    // mail($receiver_email, $sender_subject, $sender_message, "From: $sender_email");

                    // Send email to sender through this code
                    $subject = "Welcome to my website";
                    $msg = "I shall get you soon, thanks for sending us an email";
                    $from = "zihad1996.bd@gmail.com";

                    // mail($sender_email, $subject, $msg, "From: $from");
